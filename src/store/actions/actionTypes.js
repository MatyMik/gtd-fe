...
export const TOPIC_ADD_FAILED = "TOPIC_ADD_FAILED";

export const TOPIC_UPDATE_START = "TOPIC_UPDATE_START"
export const TOPIC_UPDATE_SUCCESS = "TOPIC_UPDATE_SUCCESS"
export const TOPIC_UPDATE_FAILED = "TOPIC_UPDATE_FAILED"

export const TOPIC_DELETE_START = "TOPIC_DELETE_START";
export const TOPIC_DELETE_SUCCESS = "TOPIC_DELETE_SUCCESS";
export const TOPIC_DELETE_FAILED = "TOPIC_DELETE_FAILED";
...
export const TOPIC_GET_START = "TOPIC_GET_START";
export const TOPIC_GET_SUCCESS = "TOPIC_GET_SUCCESS"
export const TOPIC_GET_FAILED = "TOPIC_GET_FAILED"


//MyFrameActions

export const GET_ITERATION_START = "GET_ITERATION_START";
export const GET_ITERATION_SUCCESS = "GET_ITERATION_SUCCESS";
export const GET_ITERATION_FAILED = "GET_ITERATION_FAILED";

export const ADD_ITERATION_START = "ADD_ITERATION_START";
export const ADD_ITERATION_SUCCESS = "ADD_ITERATION_SUCCESS";
export const ADD_ITERATION_FAILED = "ADD_ITERATION_FAILED";

export const GET_DAY_START = "GET_DAY_START";
...
export const ADD_LIST_CONTAINER_TO_DAY_START = "ADD_LIST_CONTAINER_TO_DAY_START";
export const ADD_LIST_CONTAINER_TO_DAY_FAILED = "ADD_LIST_CONTAINER_TO_DAY_FAILED";
export const ADD_LIST_CONTAINER_TO_DAY_SUCCESS = "ADD_LIST_CONTAINER_TO_DAY_SUCCESS";

export const ADD_LIST_TO_CONTAINER_START = "ADD_LIST_TO_CONTAINER_START";
export const ADD_LIST_TO_CONTAINER_SUCCESS = "ADD_LIST_TO_CONTAINER_SUCCESS";
export const ADD_LIST_TO_CONTAINER_FAILED = "ADD_LIST_TO_CONTAINER_FAILED"

export const UPDATE_MYFRAME_LIST_TITLE_START = "UPDATE_MYFRAME_LIST_TITLE_START";
export const UPDATE_MYFRAME_LIST_TITLE_SUCCESS = "UPDATE_MYFRAME_LIST_TITLE_SUCCESS";
export const UPDATE_MYFRAME_LIST_TITLE_FAILED = "UPDATE_MYFRAME_LIST_TITLE_FAILED";

export const ADD_TASK_TO_LIST_START = "ADD_TASK_TO_LIST_START";
export const ADD_TASK_TO_LIST_SUCCESS = "ADD_TASK_TO_LIST_SUCCESS";
export const ADD_TASK_TO_LIST_FAILED = "ADD_TASK_TO_LIST_FAILED";

export const ADD_TEXTFIELD_TO_DAY_START = "ADD_TEXTFIELD_TO_DAY_START";
export const ADD_TEXTFIELD_TO_DAY_SUCCESS = "ADD_TEXTFIELD_TO_DAY_SUCCESS";
export const ADD_TEXTFIELD_TO_DAY_FAILED = "ADD_TEXTFIELD_TO_DAY_FAILED";

export const ADD_TEXTFIELD_TO_CONTAINER_START = "ADD_TEXTFIELD_TO_CONTANIER_START";
export const ADD_TEXTFIELD_TO_CONTAINER_SUCCESS = "ADD_TEXTFIELD_TO_CONTANIER_SUCCESS";
export const ADD_TEXTFIELD_TO_CONTAINER_FAILED = "ADD_TEXTFIELD_TO_CONTANIER_FAILED";

export const UPDATE_TEXTFIELD_START = "UPDATE_TEXTFIELD_START";
export const UPDATE_TEXTFIELD_SUCCESS = "UPDATE_TEXTFIELD_SUCCESS";
export const UPDATE_TEXTFIELD_FAILED = "UPDATE_TEXTFIELD_FAILED";